...
import com.example.manager.CoinFetchCallback;
        ...
        firebaseAuth.signInWithEmailAndPassword(email, userPassword)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(login.this, "Authentication Failed: " + (exception != null ? exception.getMessage() : ""), Toast.LENGTH_SHORT).show();
                    }
                });
    }
