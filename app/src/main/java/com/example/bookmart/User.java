...
import com.example.extra.Preconditions;
...
public class User implements Serializable {
    ...
    public User(String username, String email, int coin, String city, String town,  String profileImg, String phoneNumber, List<String> favPostId, Enums.UserStatus userStatus) {
        this.username = username;
        this.email = email;
        this.coin = coin;
        this.City = city;
