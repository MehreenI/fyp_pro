...
public class ImageUpload {
    ...
    public ImageUpload(String bookName, String bookPrice, String imageUrl,String author,String description,String condition, String uploadDate,Enums.BookCategory bookCategory) {
